...
namespace Microsoft.Samples.Kinect.ControlsBasics
{
    ...
    public partial class MainWindow
    {
        ...
        public int[] izquierda = {10, 12};
        public int[] derecha = { 3, 2 };
        public int[] centro = { 6, 15 };
        ...
        public MainWindow()
        {
            ...
            //Activate the haptic Glove
            //glove.OpenPort("COM3", 9600);
            
            //glove.InitializeMotor(izquierda);
            //glove.InitializeMotor(derecha);
            //glove.InitializeMotor(centro);
        ...
        private void PageRightButtonClick(object sender, RoutedEventArgs e)
        {
            ...
            glove.ActivateMotor(derecha, valuesON);
            myTimer.Elapsed += new ElapsedEventHandler(ApagarMotorDer);
            myTimer.Interval = 300;
            myTimer.Start();
        }
        ...
        {
            scrollViewer.ScrollToHorizontalOffset(scrollViewer.HorizontalOffset - PixelScrollByAmount);
            glove.ActivateMotor(izquierda, valuesON);
            myTimer.Elapsed += new ElapsedEventHandler(ApagarMotorIzq);
            myTimer.Interval = 300;
            myTimer.Start();
        }
        ...
        private void ApagarMotorCentral(object source, ElapsedEventArgs e)
        {

            myTimer.Stop();
            glove.ActivateMotor(centro,valuesOFF);
            
            
        }

        private void ApagarMotorIzq(object source, ElapsedEventArgs e)
        {

            myTimer.Stop();
            glove.ActivateMotor(izquierda, valuesOFF);


        }

        private void ApagarMotorDer(object source, ElapsedEventArgs e)
        {

            myTimer.Stop();
            glove.ActivateMotor(derecha, valuesOFF);
